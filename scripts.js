...
const T = {
  zh: {
    ...
    // about / 个人介绍
    'about.eyebrow':      '关于我 · About',
    'about.name':         'Gina Wang · 王晔',
    'about.title':        '嘉程财富创始人',
    'about.cred1':        '<strong>CLU</strong> 特许财富传承规划师',
    'about.cred2':        '<strong>CHS</strong> 注册健康保险专家',
    'about.cred3':        '<strong>MDRT</strong> 环球百万圆桌终身会员',
    'about.p1':           '在加拿大金融保险业深耕20多年，专注为华人移民家庭提供保险、保本基金、税务规划、退休金规划与资产传承的一站式解决方案。',
    'about.p2':           '我深知，远渡重洋来到这里的每一个家庭，辛苦攒下的不只是财富，更是给下一代的底气。我的工作，是以专业为基石，以真诚为纽带，帮助您实现人生各阶段的财务目标，为您和家人的未来构建更稳健、更安心的财富保障。',
    'about.slogan':       '稳健守富 · 智慧传家',
    'about.cta':          '预约一对一咨询 →',
    'about.wechat':       '微信扫码联系',
    'about.photo.ph':     '在此放置您的照片<br/>advisor-photo.jpg',
    'about.articles.h':   '专业文章 · Insights',
    'about.articles.sub': '用通俗的语言，聊聊理财、税务与传承里那些真正影响你家庭的事。',
    'about.art.cta':      '阅读全文 →',
    'about.art.ph':       '📝 这是一篇占位示例文章。请把正文内容发给我，我帮您替换；或在此放上微信公众号文章链接。',
    'about.art1.tag':     '退休规划',
    'about.art1.t':       '退休规划的三大误区',
    'about.art1.p':       '很多人临到退休才发现钱不够用——问题往往出在这三个常见误区。',
    'about.art2.tag':     '税务规划',
    'about.art2.t':       '新移民必读：落地加拿大的税务规划',
    'about.art2.p':       '报税身份、登陆日资产、海外申报、TFSA/RRSP——第一步走对很重要。',
    'about.art3.tag':     '企业主',
    'about.art3.t':       '为什么要买公司保单？',
    'about.art3.p':       '用公司的钱买保险，省税、免税增长、免税传承——企业主的高效资产工具。',
    'about.art4.tag':     '财富杠杆',
    'about.art4.t':       'IFA：高收入高净值家庭的避税利器',
    'about.art4.p':       '用一张保单撬动银行融资，保留现金流，同时享免税增长与传承。',
    'about.art5.tag':     '重疾保障',
    'about.art5.t':       '加拿大有免费医疗，还需要买重疾险吗？',
    'about.art5.p':       '公费医疗能治病，却补不了收入中断和家庭开支——这正是重疾险的价值。',
    'about.art6.tag':     '资本利得',
    'about.art6.t':       'LCGE 终身资本利得免税额，我能用上吗？',
    'about.art6.p':       '卖掉公司可能有上百万的免税额——但你的公司“合格”吗？',
    'about.art7.tag':     '免税投资',
    'about.art7.t':       '加拿大真正的免税投资账户——TFSA',
    'about.art7.p':       'TFSA 不只是“储蓄账户”——它里面赚的每一分钱，取出来时一分税都不用交。',
    'about.art8.tag':     '子女规划',
    ...
    'tile.life.h':    '寿险 & 重疾险',
    'tile.life.p':    '全面代理 Sun Life、Manulife、Canada Life、IA、Equitable Life、BMO Insurance、Foresters 等多家保险公司，为您和家人、为企业主构建长期财务安全网。',
    'tile.cta':       '立即报价 →',
    'tile.life.cta':  '咨询顾问 →',
  ...
  en: {
    ...
    'about.name':         'Gina Wang',
    'about.title':        'Founder, GWY Financial',
    'about.cred1':        '<strong>CLU</strong> Chartered Life Underwriter',
    'about.cred2':        '<strong>CHS</strong> Certified Health Insurance Specialist',
    'about.cred3':        '<strong>MDRT</strong> Million Dollar Round Table Lifetime Member',
    'about.p1':           'With over 20 years of experience in Canada\'s financial and insurance industry, I provide Chinese immigrant families with one-stop solutions for insurance, segregated funds, tax planning, retirement planning, and wealth succession.',
    'about.p2':           'I understand that for every family who crossed an ocean to start over here, what you\'ve worked so hard to build is more than wealth — it\'s security for the next generation. With professionalism as the foundation and sincerity as the bond, my work is to help you reach your financial goals at every stage of life, and build a more secure, more reassuring future for you and your family.',
    'about.slogan':       'Safeguarding Wealth · Passing on Wisdom',
    'about.cta':          'Book a 1-on-1 Consultation →',
    'about.wechat':       'Scan to connect on WeChat',
    'about.photo.ph':     'Add your photo here<br/>advisor-photo.jpg',
    'about.articles.h':   'Insights',
    'about.articles.sub': 'Plain-language thoughts on the financial, tax, and legacy decisions that truly matter to your family.',
    'about.art.cta':      'Read more →',
    'about.art.ph':       '📝 This is a placeholder article. Send me the full text and I\'ll add it here — or link it to your WeChat article.',
    'about.art1.tag':     'Retirement',
    'about.art1.t':       'Three Myths About Retirement Planning',
    'about.art1.p':       'Many people realize too late that their savings fall short — usually because of these three common mistakes.',
    'about.art2.tag':     'Tax Planning',
    'about.art2.t':       'New to Canada? A Primer on Tax Planning',
    'about.art2.p':       'Tax residency, landing-day assets, foreign reporting, TFSA/RRSP — getting the first steps right matters.',
    'about.art3.tag':     'Business Owners',
    'about.art3.t':       'Why Buy Corporate-Owned Life Insurance?',
    'about.art3.p':       'Pay with corporate dollars for tax savings, tax-free growth and tax-free legacy — an efficient tool for owners.',
    'about.art4.tag':     'Wealth Leverage',
    'about.art4.t':       'IFA: A Tax Tool for High-Net-Worth Families',
    'about.art4.p':       'Use one policy to unlock bank financing — keep cash flow while enjoying tax-free growth and legacy.',
    'about.art5.tag':     'Critical Illness',
    'about.art5.t':       'Free Healthcare in Canada — Do You Still Need CI Cover?',
    'about.art5.p':       'Public healthcare treats illness but can\'t replace lost income — that\'s the value of critical illness cover.',
    'about.art6.tag':     'Capital Gains',
    'about.art6.t':       'The Lifetime Capital Gains Exemption — Can You Use It?',
    'about.art6.p':       'Selling your company could come with a million-dollar exemption — but does your company qualify?',
    'about.art7.tag':     'Tax-Free Investing',
    'about.art7.t':       'Canada\'s Truly Tax-Free Investment Account — the TFSA',
    'about.art7.p':       'More than a savings account — every dollar of growth comes out completely tax-free.',
    'about.art8.tag':     'Kids',
    ...
    'gif.row4':  'Death benefit (principal guaranteed)',                      'gif.row5': 'Named beneficiary',       'gif.row6': 'Probate bypass',
    ...
    'tile.life.p':    'A full-service broker for Sun Life, Manulife, Canada Life, IA, Equitable Life, BMO Insurance, Foresters and more — building a long-term financial safety net for you, your family, and business owners.',
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // 跨页面打开弹窗：如 index.html#modal-travel 自动展开对应产品弹窗
  const h = location.hash;
  if (h && h.startsWith('#modal-') && document.getElementById(h.slice(1))) {
    openModal(h.slice(1));
  }
});
